<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" x-data="themeSwitcher()" x-init="init()" data-theme="">
...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ asset('storage/images/favicon.png') }}" type="image/png" sizes="128x128">
